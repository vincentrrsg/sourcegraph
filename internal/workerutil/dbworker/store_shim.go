...
func (s *storeShim[T]) Heartbeat(ctx context.Context, ids []int) (knownIDs []int, err error) {
...
func (s *storeShim[T]) CanceledJobs(ctx context.Context, knownIDs []int) ([]int, error) {
