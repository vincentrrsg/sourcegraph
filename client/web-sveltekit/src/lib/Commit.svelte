<script lang="ts">
    import type { GitCommitFields } from '@sourcegraph/web/src/graphql-operations'
    ...
    // TODO: Update relative time for very recent commits
    $: relativeTime = getRelativeTime(new Date(commit.committer ? commit.committer.date : commit.author.date))
