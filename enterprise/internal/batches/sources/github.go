...
func (s GithubSource) GetNamespaceFork(ctx context.Context, targetRepo *types.Repo, namespace string) (*types.Repo, error) {
	return s.getFork(ctx, targetRepo, s.client, &namespace)
}
...
func (s GithubSource) GetUserFork(ctx context.Context, targetRepo *types.Repo) (*types.Repo, error) {
	...
	return s.getFork(ctx, targetRepo, s.client, nil)
}
...
func (s *GithubSource) getFork(ctx context.Context, targetRepo *types.Repo, client githubClientFork, namespace *string) (*types.Repo, error) {
